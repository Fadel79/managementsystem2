...
if (isset($_POST['pdf_stock_out'])) {
  header("Location: pdf_stock_out.php");
  exit();
}
    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        ...
        <form method="POST" style="display: inline;">
          <a href="add_stock_out.php" class="btn btn-info pull-right btn-sm" style="margin-left: 5px;">
            <span class="glyphicon glyphicon-plus"></span> Add Stock Out
          </a>
          <button type="submit" name="pdf_stock_out" class="btn btn-info pull-right btn-sm">
