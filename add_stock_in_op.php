...
if (isset($_POST['add_stock_in_op'])) {
  ...
  if (empty($errors)) {
    ...
    if ($db->query($query)) {
      ...
      redirect('add_stock_in_op.php', false);
    }
  } else {
  ...
  <div class="col-md-9">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="add_stock_in_op.php">
          ...
          <button type="submit" name="add_stock_in_op" class="btn btn-primary">Add</button>
        </form>
      </div>
    </div>
  </div>
