...
if (isset($_POST['pdf_stock_in'])) {
  header("Location: pdf_stock_in.php");
  exit();
}
...
<div class="row">
  ...
  <form method="POST" style="display: inline;">
    <a href="add_stock_in.php" class="btn btn-info pull-right btn-sm" style="margin-left: 5px;">
      <span class="glyphicon glyphicon-plus"></span> Add Stock In
    </a>
    <button type="submit" name="pdf_stock_in" class="btn btn-info pull-right btn-sm">
